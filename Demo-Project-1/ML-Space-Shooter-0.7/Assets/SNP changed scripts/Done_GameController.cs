...
public class Done_GameController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.P) && playerAgent.brain is CoreBrainInternal)
        {
        ...
        if (Input.GetKeyDown(KeyCode.M) && playerAgent.brain is CoreBrainPlayer)
        {
    ...
    public void GameOver()
    {
        ...
        if (playerAgent.brain is CoreBrainPlayer)
        {
            gameOver = true;
